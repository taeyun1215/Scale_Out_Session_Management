...
ENTRYPOINT ["java", "-jar", "-javaagent:./pinpoint/pinpoint-bootstrap-2.2.2.jar", "-Dpinpoint.agentId=adventcalendarDev1", "-Dpinpoint.applicationName=adventcalendar1", "-Dpinpoint.config=./pinpoint/pinpoint-root.config", "-Duser.timezone=Asia/Seoul", "/app.jar"]
